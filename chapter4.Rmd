...
For the LDA biplot a function has to be created to show the lda arrows for the different variable in the plot. The code for this function was taken from the datacamp exercise which refers to following [Stack Overflow message thread](https://stackoverflow.com/questions/17232251/how-can-i-plot-a-biplot-for-lda-in-r). 
